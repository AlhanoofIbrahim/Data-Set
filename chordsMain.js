...
var NameProvider = ["","Stationary", "Bags", "Books", "Electronic", "Clothes"];

var matrix = [
	[0,0,0,0,0,0], /*MF*/
	[0,0.288,0.298,0.103,0.300,0.195], /*Stat*/
	[0,0.288,0.298,0.103,0.300,0.195], /*Bags*/
	[0,0.288,0.298,0.103,0.300,0.195], /*Book*/
	[0,0.288,0.298,0.103,0.300,0.195], /*Electronic*/
	[0,0.288,0.298,0.103,0.300,0.195] /*Clothes*/
];
/*Sums up to exactly 100*/

var colors = ["#ffffff","#C4C4C4", "#69B40F", "#EC1D25", "#C8125C", "#008FC8"];
...
var middleTextTop = textCenter.append("text")
	...
	.attr("dy", "1em")
	.attr("opacity", 1)
	.text("People behavior in Black Friday")
	.call(wrap, 350);
...
var middleTextBottom = textCenter.append("text")
	...
	.attr("dy", "1em")
	.attr('opacity', 1)
	.text("There are some information about the most selles category.")
	.call(wrap, 350);
